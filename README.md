...
**Does it keep my clipboard private?** Yes. Everything stays on your Mac - no servers, no analytics, and no network calls by default - and password-manager clips are ignored. (One optional feature, link previews, fetches link titles and icons from the web and loads the page itself when you preview a link clip; it's off unless you turn it on.)
