...
/// A confirmation surface that deliberately cannot become key or take focus
/// away from the app that will receive the user's next paste.
private final class CopyToastPanel: NSPanel {
...
final class CopyToastController {
    private let panel: CopyToastPanel
    private var dismissWorkItem: DispatchWorkItem?

    init() {
        panel = CopyToastPanel(
