...
private enum SettingsSection: CaseIterable, Identifiable {
    ...
    var subtitle: String {
        ...
        case .shortcuts: "Keyboard controls for Pesty and Quick Paste"
                                    ...
                                    HStack(spacing: 0) {
                                        ForEach(HistoryRetention.allCases) { retention in
                                            Text(retention.shortSliderTitle)
                                                .font(.system(
                                                    size: 10,
                                                    weight: retention == settings.historyRetention ? .bold : .medium
                                                ))
                                                .foregroundStyle(
                                                    retention == settings.historyRetention ? Color.accentColor : .secondary
                                                )
